                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => const BodyWeightPage(),
                            ),
                          );
                        },
                        child: Container(
                              ...
                              const Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 4),
                                    Text(
                                      'Catat & lihat grafik perkembangan berat badanmu',
                                      style: TextStyle(color: Colors.grey, fontSize: 13),
                                    ),
                                  ],
                                ),
                              ),
                              const Icon(Icons.chevron_right, color: Color(0xFF7B61FF)),
                            ],
                          ),
                        ),
                      ),
